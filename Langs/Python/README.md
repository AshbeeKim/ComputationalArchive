<html lang="ko">
    ...
    <head>
        ...
        <style>
            ...
            hr.h1 {color:#0174b7; border:double;}
            h2 {
                text-align: center;
                font-family: 'Poiret One'; font-weight: 900;
            }
            h2 span {
                background : linear-gradient(to right, #0174b7, #f8ba0a);
    ...
    <body>
        ...
        <!--contents-->
        <h1 id="Langs"><b>Python</b></h1><hr class="h1"/>
        ...
        <!--LaTex-->
        <h2><span>Papers</span></h2><hr class="h2"/>
        $$$$
        <!--footer-->
